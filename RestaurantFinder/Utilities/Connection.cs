...
namespace Utilities
{
    public class DBConnect
    {
        ...
        String SqlConnectString = "server=cis-mssql1.temple.edu;Database=sp22_3342_tuh32402;User id=tuh32402;Password=ei9gahGe7u";

        // Home Connection String - used for working from home using SSH Tunneling.
        //String SqlConnectString = "server=127.0.0.1,5555;Database=sp22_3342_tuh32402;User id=tuh32402;Password=ei9gahGe7u";
